<template>
  <span :class="getClasses().badge" class="inline-flex items-center font-medium rounded-full">
    <svg v-if="dot" :class="getClasses().dot" class="-ml-0.5 mr-1.5 h-2 w-2" fill="currentColor" viewBox="0 0 8 8">
    ...
    getClasses() {
      ...
      switch (this.color) {
        ...
        case 'pink':
          ...
          break;
        case 'brand':
          badgeClasses += 'bg-brand text-purple-1000';
          dotClasses += 'text-purple-1000';
          break;
        case 'purple':
          badgeClasses += 'bg-purple-900 text-purple-200';
          dotClasses += 'text-purple-200';
          break;
      }
      switch (this.size) {
        case 'base':
