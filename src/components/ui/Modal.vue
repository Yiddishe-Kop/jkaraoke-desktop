  ...
  <transition name="modal-fade">
    ...
    >
      ...
      <div @click="cancel" class="fixed inset-0 transition-opacity">
        <div class="absolute inset-0 transition bg-opacity-25 bg-purple-1000" style="backdrop-filter: blur(5px)"></div>
      </div>
      ...
      switch (this.modal.color) {
        ...
        case 'purple':
          return {
            ...
            button: 'bg-purple-600 hover:bg-purple-500 focus:border-purple-700 focus:shadow-outline-purple',
          };
      }
    },
  },
